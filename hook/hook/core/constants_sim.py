...
HOSE_ANGLE_KP = 0.02924  # 0.00731 * 4
HOSE_ANGLE_MAX_VELOCITY = 0.44  # 0.11 * 4
HOSE_CENTER_KP = 1.36  # 0.34 * 4
HOSE_CENTER_MAX_VELOCITY = 0.60  # 0.15 * 4
SPHERE_ANCHOR_KP = 0.68  # 0.17 * 4
